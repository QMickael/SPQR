...
LAST_UPDATE			= "23th Oct 2017"
CODELINES			= "5757"
FULLSCREEN			= False

## factions
PLAYABLE_FACTIONS		= ['romans', 'greeks', 'carthage', 'germania', 'egypt', 'gaul']
UNPLAYABLE_FACTIONS		= []
...
GRAPHICS_F			= ["gui", "icons", "units", "cities" ,"map/regions", "units/overlays", 'board']
GRAPHICS_D			= ['buildings', 'factions']
